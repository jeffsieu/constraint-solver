...
import { HoveredEntityProvider } from "@/hooks/use-hovered-entity";
                      ...
                      <div className="space-y-8">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mb-4">
                            ...
                            record can have at most one attribute from each
                            group.
                          </p>
                    ...
                    <Card className="p-12 text-center">
                      <div className="text-muted-foreground">
                        ...
                        <p className="text-sm mt-2">
                          Configure your problem and click "Solve Problem" to
                          see results
                        </p>
                      </div>
                    </Card>
                  ...
                  >
                    ...
                    >
                      <VisuallyHidden>
                        ...
                        <DrawerDescription>
                          View the optimal solution that matches your
                          requirements
                        </DrawerDescription>
                      </VisuallyHidden>
